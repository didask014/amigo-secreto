...
let amigoSorteado = etiquetaLista("resultado");
...
// Codigo de las listas
    ...
    // Ingresa la lista y el elemento que quieras ingresar a esa lista
...
// Generación del nombre sorteado
    ...
    function sortearAmigo() {
        if (comprobarNulidadAmigos()){
            borrarAnteriorListaHTML(amigoSorteado);
            addtoListaHTML(amigoSorteado, obtenerNombreSorteado());
        }else{
